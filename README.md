...
### Step 1
🟢 Nvidia GPU ➜ Install [CUDA 11.8](https://developer.nvidia.com/cuda-11-8-0-download-archive) (CUDA 12.1 is not currently supported by the faster-whisper library that my program uses).
