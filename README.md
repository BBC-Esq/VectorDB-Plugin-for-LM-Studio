...
```
  > If this still fails, you can try going [HERE](https://download.pytorch.org/whl/cu118) and manually "pip install" the appropriate wheels for your setup.  Make sure and install ```torch```, ```torchaudio```, and ```torchvision```.
### Step 8
```
