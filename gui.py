...
class DocQA_GUI:
    def __init__(self, root):
        ...
        # LEFT FRAME
        left_frame = tk.Frame(main_pane, bg="#202123", highlightthickness=0, relief='flat', borderwidth=0)
        ...
        self.download_embedding_model_button = tk.Button(
            left_frame, text="Download Embedding Model", width=29, bg="#323842", fg="light gray", font=("Segoe UI Historic", 10))
        self.download_embedding_model_button.pack(pady=2)

        self.select_embedding_model_button = tk.Button(
            left_frame, text="Select Embedding Model Directory", width=29, bg="#323842", fg="light gray", font=("Segoe UI Historic", 10))
        self.select_embedding_model_button.pack(pady=2)

        self.choose_documents_button = tk.Button(
            left_frame, text="Choose Documents for Database", width=29, bg="#323842", fg="light gray", font=("Segoe UI Historic", 10))
        self.choose_documents_button.pack(pady=2)

        self.create_chromadb_button = tk.Button(
            left_frame, text="Create Vector Database", width=29, bg="#323842", fg="light gray", font=("Segoe UI Historic", 10))
        self.create_chromadb_button.pack(pady=2)
        main_pane.add(left_frame)

        # RIGHT FRAME
        right_frame = tk.Frame(main_pane, bg="#202123", highlightthickness=0, relief='flat', borderwidth=0)
        main_pane.add(right_frame)

        # For displaying the answer
        middle_frame = tk.Frame(right_frame, bg="#1e263c", highlightthickness=0, relief='flat', borderwidth=0)
