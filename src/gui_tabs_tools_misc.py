from PySide6.QtWidgets import (
    QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QWidget, QMessageBox, QComboBox
)
...
class MiscTab(QWidget):
    def __init__(self):
        ...
        self.restore_backup_button = QPushButton("Restore Database Backups")
    ...
    def on_backup_finished(self, success):
        ...
        self.set_button_text(self.backup_all_button, "Backup All Databases")
        if success:
    ...
    def on_restore_finished(self, success):
        self.set_buttons_enabled(True, [self.backup_all_button, self.restore_backup_button])
        self.set_button_text(self.restore_backup_button, "Restore Database Backups")
        if success:
