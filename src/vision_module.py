...
import torch
from transformers import LlamaTokenizer, AutoModelForCausalLM, AutoProcessor, LlavaForConditionalGeneration
import time
import os
import textwrap
import yaml
    ...
    def llava_process_images(self):
        ...
        try:
            with Image.open(test_image_path) as raw_image, open(output_file_path, "w", encoding="utf-8") as output_file:
                ...
                wrapped_response = self.wrap_text(model_response, 130)
